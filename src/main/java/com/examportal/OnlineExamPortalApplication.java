...
public class OnlineExamPortalApplication implements CommandLineRunner {

	private final Logger LOG = LoggerFactory.getLogger(OnlineExamPortalApplication.class);
